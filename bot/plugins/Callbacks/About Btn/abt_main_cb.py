...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Support Group:</i></b> <a href="https://t.me/MMCINEMACHAKKU">@MMCINEMACHAKKU</a>\n"""
    text+="""\n<b><i>Upload CHANNEL:</i></b> <a href="https://t.me/+yP9ckmsoGF1kNDNl">Source</a>"""

    buttons = [
        [
            InlineKeyboardButton
                (
                    "♻️GROUP", url="https://t.me/MMCINEMACHAKKU"
                ),
